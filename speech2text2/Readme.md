...
step 1. open anconda prompt and type : conda activate signlang  
...
You should see real-time text printed in the anconda prompt terminal.
Press Ctrl+C or quit to stop.
